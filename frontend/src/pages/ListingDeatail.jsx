...
import { mdiWashingMachine, mdiMicrowave, mdiWifi, mdiHomeCircleOutline, mdiThumbsUpDown } from '@mdi/js';
        ...
        <>
          ...
          <Container maxWidth="md" component="main">
            ...
            <Typography
              ...
              gutterBottom
            >
              Property type : {listDeatail.metadata.propertyType}
            </Typography>
            ...
            <Divider />
            <Typography variant="h5" color="text.primary" sx={{ py: 3 }}>
            ...
            {listDeatail.metadata.amenities.length
              ? (<Grid>
                ...
                {checkAmenities('Wifi') && <Grid container alignItems={'center'} sx={{ pt: 3 }}>
                ...
                {checkAmenities('Oven') && <Grid container alignItems={'center'} sx={{ pt: 3 }}>
                ...
                {checkAmenities('Wash Machine') && <Grid container alignItems={'center'} sx={{ pt: 3 }}>
